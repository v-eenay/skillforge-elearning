...
/**
 * Servlet for viewing a lesson
 */
@WebServlet(name = "ViewLessonServlet", urlPatterns = {"/instructor/view-lesson"})
public class ViewLessonServlet extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(ViewLessonServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("/WEB-INF/views/instructor/view-lesson.jsp").forward(request, response);

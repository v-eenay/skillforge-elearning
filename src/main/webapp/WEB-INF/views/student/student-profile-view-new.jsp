    ...
    <div class="container">
        <div class="row profile-header">
            ...
            <div class="col-md-4 text-end">
                ...
                <a href="${pageContext.request.contextPath}/student/profile/edit" class="btn btn-primary">
            ...
            <div class="col-lg-4 profile-animate">
                <div class="profile-card profile-sidebar">
                    ...
                    <div class="profile-actions">
                        <a href="${pageContext.request.contextPath}/student/profile/edit" class="profile-action-btn primary">

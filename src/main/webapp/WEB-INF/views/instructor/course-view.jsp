                    ...
                    <div class="course-thumbnail-container">
                        <c:choose>
                            <c:when test="${not empty course.thumbnail}">
                                <img src="${pageContext.request.contextPath}${course.thumbnail}" alt="${course.title}" class="img-fluid rounded" onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/assets/images/course-thumbnail.svg';">
                            </c:when>
                            <c:otherwise>
                                <img src="${pageContext.request.contextPath}/assets/images/course-thumbnail.svg" alt="${course.title}" class="img-fluid rounded">
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>

    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <h5 class="text-gradient mb-4">SkillForge</h5>
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="#" class="text-decoration-none text-dark">Courses</a></li>
                    <li class="mb-2"><a href="#" class="text-decoration-none text-dark">Instructors</a></li>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <address class="mb-4">
                    <p class="mb-1"><a href="mailto:koiralavinay@gmail.com" class="text-decoration-none text-dark">koiralavinay@gmail.com</a></p>
                    <p class="mb-0"><a href="mailto:binaya.koirala@iic.edu.np" class="text-decoration-none text-dark">binaya.koirala@iic.edu.np</a></p>
                </address>
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="mt-4">
                            ...
                            <a href="${pageContext.request.contextPath}/student/dashboard" class="btn btn-outline-primary rounded-pill">Dashboard</a>
                        </div>
                    </c:otherwise>
                </c:choose>
            </div>
        ...
        <div class="text-center" style="background-color: #f8f9fa;">
            <div class="d-flex justify-content-center align-items-center flex-column">
                <div class="mb-3">
                    <span class="text-gradient fw-bold fs-5">Vinay Koirala</span>
                    <span class="ms-2">SkillForge ™ All rights reserved.</span>
                    <span class="copyright-year">© <span class="fw-semibold"><%= java.time.Year.now().getValue() %></span></span>
                </div>
            </div>
        </div>
    </div></footer>

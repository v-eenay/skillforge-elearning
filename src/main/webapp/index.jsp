        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <img src="https://placedog.net/500/300?id=1" class="card-img-top rounded-top" alt="Web Development Course">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <img src="https://placedog.net/500/300?id=2" class="card-img-top rounded-top" alt="Data Science Course">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm h-100">
                    <img src="https://placedog.net/500/300?id=3" class="card-img-top rounded-top" alt="Digital Marketing Course">
                    <div class="card-body">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 text-center">
                <div class="p-4 border border-dark rounded-4 shadow-sm">
                    <img src="https://placedog.net/200/200?id=3" alt="Top Instructor" class="rounded-circle mb-3" style="width: 150px; height: 150px;">
            ...
            <c:forEach var="i" begin="4" end="8">
                <div class="col-md-3">
                    <div class="card text-center border-0 shadow-sm h-100">
                        <img src="https://placedog.net/200/200?id=${i}" class="card-img-top rounded-circle mx-auto mt-3" style="width: 120px; height: 120px;" alt="Instructor">
                        <div class="card-body">
...
<section class="py-5 bg-white">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 text-center">
                <div class="p-4 border border-dark rounded-4 shadow-sm">
                    <img src="https://placedog.net/200/200?id=11" alt="Top Student" class="rounded-circle mb-3" style="width: 150px; height: 150px;">
            ...
            <c:forEach var="t" begin="8" end="10">
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100 p-4 text-center">
                        <img src="https://placedog.net/100/100?id=${t}" class="rounded-circle mx-auto mb-3" alt="Student">
